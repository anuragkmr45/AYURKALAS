        ...
        >
          <div className="flex justify-center items-center">
            {session?.user ? (
              ...
              <MdSwitchAccount className="text-2xl text-gray-900 -translate-x-12 group-hover:translate-x-3 transition-transform duration-200" />
            )}
            ...
            {session?.user ? (
              ...
              <MdSwitchAccount className="text-2xl text-gray-900 -translate-x-3 group-hover:translate-x-12 transition-transform duration-200" />
            )}
          </div>
          <p className="text-xs text-black font-semibold">Profile</p>
        </Link>
      )}
